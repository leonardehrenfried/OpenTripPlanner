...
import org.opentripplanner.routing.graphfinder.ChronologicalGraphPath;
...
public class StreetFlexPathCalculator implements FlexPathCalculator {
  ...
  public FlexPath calculateFlexPath(
    ...
    var path = ChronologicalGraphPath.of(state);
    ...
    return new FlexPath((int) path.effectiveWalkDistance(), (int) state.getElapsedTimeSeconds(), () ->
