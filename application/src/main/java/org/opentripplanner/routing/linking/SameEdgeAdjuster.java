  ...
  public static DisposableEdgeCollection adjust(Vertex from, Vertex to, Graph graph) {
    ...
    try {
      ...
      for (Edge outgoing : from.getOutgoing()) {
        ...
        } else if (outgoing instanceof TemporaryPartialStreetEdge && from instanceof StreetVertex vertex) {
      ...
      for (Edge incoming : to.getIncoming()) {
        ...
        } else if (incoming instanceof TemporaryPartialStreetEdge && to instanceof StreetVertex vertex) {
