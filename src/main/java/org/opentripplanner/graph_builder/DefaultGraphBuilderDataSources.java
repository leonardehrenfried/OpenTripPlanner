 ...
 */
public class DefaultGraphBuilderDataSources implements GraphBuilderDataSources {

    private static final Logger LOG = LoggerFactory.getLogger(DefaultGraphBuilderDataSources.class);
    ...
    private DefaultGraphBuilderDataSources(
     ...
     */
    public static DefaultGraphBuilderDataSources create(
            CommandLineParameters cli,
            BuildConfig bc,
            OtpDataStore store

    ) {
        return new DefaultGraphBuilderDataSources(cli, bc, store);
    }
